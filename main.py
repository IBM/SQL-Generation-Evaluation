...
if __name__ == "__main__":
    ...
    parser.add_argument("-col", "--chromadb_collection_name", type=str, default=None)
    ...
    if args.model_type == "wx":
        from eval.watsonx_runner import run_watsonx_eval

        run_watsonx_eval(args)
